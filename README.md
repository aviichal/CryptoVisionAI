...
git clone https://github.com/yourusername/CryptoVisionAI.git
...
Run the project:
python crypto_vision_ai.py
Usage
Register a new user: Follow the prompts to enter your email, password, full name, and initial bank balance.
Log in: Use your registered email and password to log in to the system.
Manual Trade: Select cryptocurrencies to buy manually by entering the price and quantity.
Auto-buy: Use the AI-powered assistant to predict future prices and automatically buy cryptocurrencies if the profit target is met.
View Portfolio: Check your portfolio to see all your current holdings.
Fraud Detection: Run the fraud detection algorithm to check for anomalies in your trade history.
How to Add New Cryptocurrencies
To add more cryptocurrencies to the supported list, update the cryptos dictionary in the code:
...
Ensure the id corresponds to the CoinGecko API cryptocurrency identifier.

API Integration
This project fetches historical price data from the CoinGecko API. If you want to extend the functionalities, you can explore additional endpoints from the CoinGecko API Documentation.
